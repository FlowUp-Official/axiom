...
hero:
  name: Axiom
  text: Code generator for SQL schemas, models, and queries
  tagline: Type-safe TypeScript and Rust clients generated from your SQL and .axm models, with sub-millisecond incremental rebuilds — built for large monorepos.
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - title: Polyglot from one source
    details: The same SQL schemas and .axm models and queries generate consistent, type-safe TypeScript and Rust client code.
  ...
  - title: Declarative validation
    details: Email, UUID, range, length, regex, and normalization rules declared in .axm models compile straight into the generated code.
